...
<table style="border-collapse: collapse; width: 100%;" border="1">
  <tbody>
    ...
    <tr>
      <td style="width: 50%;">
      <p><strong>[Wiki] Attach Effect</strong></p>
<pre><code class="lua">
...
map:setShader('Map - Party')
    ...
    <tr>
      <td style="width: 50%;">
       <strong> <p>[Wiki] Discord RPC</p></strong>
  ...
  and configure the others definitions
    ...
    <tr>
      <td style="width: 50%;">
       <strong> <p>[Wiki] Typing Icon</strong></p>
        <pre><code>
...
and set draw-typing: true
    ...
    <tr>
      <td style="width: 50%;">
       <strong> <p>[Wiki] Colored text</p></strong>
        <pre><code class="lua">
