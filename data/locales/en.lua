...
-- death screen
locale:translate("DeathWindowTitle", "You are dead")
...
-- rule violation
locale:translate("RuleViolationRule1a", "1a) Offensive Name")
locale:translate("RuleViolationRule1b", "1b) Invalid Name Format")
locale:translate("RuleViolationRule1c", "1c) Unsuitable Name")
locale:translate("RuleViolationRule1d", "1d) Name Inciting Rule Violation")
locale:translate("RuleViolationRule2a", "2a) Offensive Statement")
locale:translate("RuleViolationRule2b", "2b) Spamming")
locale:translate("RuleViolationRule2c", "2c) Illegal Advertising")
locale:translate("RuleViolationRule2d", "2d) Off-Topic Public Statement")
locale:translate("RuleViolationRule2e", "2e) Non-English Public Statement")
locale:translate("RuleViolationRule2f", "2f) Inciting Rule Violation")
locale:translate("RuleViolationRule3a", "3a) Bug Abuse")
locale:translate("RuleViolationRule3b", "3b) Game Weakness Abuse")
locale:translate("RuleViolationRule3c", "3c) Using Unofficial Software to Play")
locale:translate("RuleViolationRule3d", "3d) Hacking")
locale:translate("RuleViolationRule3e", "3e) Multi-Clienting")
locale:translate("RuleViolationRule3f", "3f) Account Trading or Sharing")
locale:translate("RuleViolationRule4a", "4a) Threatening Gamemaster")
locale:translate("RuleViolationRule4b", "4b) Pretending to Have Influence on Rule Enforcement")
locale:translate("RuleViolationRule4c", "4c) False Report to Gamemaster")
locale:translate("RuleViolationDestructiveBehaviour", "Destructive Behaviour")
locale:translate("RuleViolationExcessivePK", "Excessive Unjustified Player Killing")
locale:translate("RuleViolationActionNote", "Notation")
locale:translate("RuleViolationActionNamelock", "Name Report")
locale:translate("RuleViolationActionBan", "Banishment")
locale:translate("RuleViolationActionBanPlusNamelock", "Name Report + Banishment")
locale:translate("RuleViolationActionBanPlusFinalWarning", "Banishment + Final Warning")
locale:translate("RuleViolationActionBanPlusFinalPlusNamelock", "Name Report + Banishment + Final Warning")
locale:translate("RuleViolationActionReport", "Statement Report")
locale:translate("RuleViolationNeedAction", "You must select an action.")
locale:translate("RuleViolationNeedReason", "You must select a reason.")
locale:translate("RuleViolationNeedStatement", "No statement has been selected.")
locale:translate("RuleViolationNeedComment", "You must enter a comment.")
locale:translate("RuleViolationLabelPlayerName", "Name")
locale:translate("RuleViolationLabelPlayerMessage", "Statement")
locale:translate("RuleViolationLabelPenaltyReason", "Reason")
locale:translate("RuleViolationLabelAction", "Action")
locale:translate("RuleViolationCheckboxIpBan", "IP Address Banishment")
locale:translate("RuleViolationLabelComment", "Comment")

-- screenshot
locale:translate("ScreenshotCheckboxGameWindow", "Only Capture Game Window")
locale:translate("ScreenshotTooltipGameWindow", "If you check this option, the screenshots will only be taken from\nthe game window instead of the complete client interface. This\nmight improve your game performance, particularly if you have\nticked the Screenshot Backlog option.")
locale:translate("ScreenshotCheckboxBacklog", "Keep Blacklog of the Screenshots of the Last 5 Seconds")
locale:translate("ScreenshotTooltipBacklog", "If you check this option, the client takes a screenshot every\nsecond and caches the last 5 of them. Whenever a screenshot is\ntaken either automatically for a selected event or manually using a\nhotkey, also the screenshots of the previous 5 seconds will be\nsaved.\nIf you experience frame stuttering, you should consider disabling\nthis option.")
locale:translate("ScreenshotCheckboxAutoCapture", "Enable Auto Screenshots")
locale:translate("ScreenshotTooltipAutoCapture", "Enable this option to save screenshots of the most important\nmoments of your career! Whenever one of the events you\nhave selected takes place, a screenshot will be taken\nautomatically.\n\nThe following events can be selected to trigger an auto screenshot:\n\n- Level Up: Your character has reached the next level\n- Skill Up: You advanced in one of your skills (e.g. Magic Level\nor Sword Fighting)\n- Achievement: You earned an achievement, either while\nplaying or upon login\n- Bestiary Entry Unlocked: You unlocked new information\nabout a creature in the Bestiary\n- Bestiary Entry Completed: You unlocked all information about\na creature in the Bestiary\n- Treasure Found: You received some reward from a container\nfor solving a quest or a riddle\n- Valuable Loot: You just found some loot which you have\nmarked in the Drop Tracker\n- Boss Defeated: You defeated a boss monster, either alone or\ntogether with other players, and are entitled to loot it\n- Death PvE: You were just killed by some creature (PvE)\n- Death PvP: You were just killed by another player (PvP)\n- Player Kill: You defeated another player\n- Player Killer Assist: You assisted the killing of another player\n- Player Attacking: Another player just started to attack you\n- Highest Damage Dealt: You dealt a new all-time high damage\non a foe. To see or reset your current all-time high, check\nthe Impact Analyser\n- Highest Healing Done: You healed someone with a new all-\ntime high healing value. To see or reset your current all-time\nhigh, check the Impact Analyser\n- Low Health: You have reached a threshold of deep red\nhealth Copy")
locale:translate("ScreenshotLabelAutoCapture", "Select all events that should trigger auto Screenshots")
locale:translate("ScreenshotButtonOpenFolder", "Open Screenshots Folder")
...
locale:translate("StoreWindowTitle", "Store")
locale:translate("StoreButtonBuyPoints", "Buy points")
