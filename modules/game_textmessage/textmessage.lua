...
function displayMessage(mode, text)
    ...
    if msgtype.consoleTab ~= nil and
        ...
        if msgtype == MessageSettings.loot then
            ...
            modules.game_console.addText(lootColoredText, msgtype, localize("Server Log"))
            modules.game_console.addText(lootColoredText, msgtype, localize(msgtype.consoleTab))
        else
